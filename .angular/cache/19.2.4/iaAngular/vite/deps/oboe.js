...
var require_oboe_browser = __commonJS({
  "node_modules/oboe/dist/oboe-browser.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      ...
      else if (typeof define === "function" && define.amd) define("oboe", [], factory);
      else if (typeof exports === "object") exports["oboe"] = factory();
      else root["oboe"] = factory();
        ...
        function(modules) {
          ...
          function(module2, __webpack_exports__, __webpack_require__) {
            ...
            function arrayAsList(inputArray) {
              return reverseList(inputArray.reduce(Object(__WEBPACK_IMPORTED_MODULE_0__functional__[
                "e"
                /* flip */
              ])(cons), emptyList));
            }
            ...
            function incrementalContentBuilder(oboeBus) {
              ...
              function arrayIndicesAreKeys(possiblyInconsistentAscent, newDeepestNode) {
                ...
                return Object(__WEBPACK_IMPORTED_MODULE_2__util__[
                  "c"
                  /* isOfType */
                ])(Array, parentNode) ? keyFound(possiblyInconsistentAscent, Object(__WEBPACK_IMPORTED_MODULE_2__util__[
                  "e"
                  /* len */
                ])(parentNode), newDeepestNode) : (
            ...
            function wire(httpMethodName, contentSource, body, headers, withCredentials) {
              ...
              if (contentSource) {
                Object(__WEBPACK_IMPORTED_MODULE_7__streamingHttp_node__[
                  "b"
                  /* streamingHttp */
                ])(oboeBus, Object(__WEBPACK_IMPORTED_MODULE_7__streamingHttp_node__[
                  "a"
                  /* httpTransport */
              ...
              function addUnderlyingListener(fullEventName, predicateEvent, compiledJsonPath) {
                ...
                predicateEvent.on(function(ascent) {
                  ...
                  if (maybeMatchingMapping !== false) {
                    emitMatchingNode(emitMatch, Object(__WEBPACK_IMPORTED_MODULE_2__ascent__[
                      "c"
                      /* nodeOf */
            ...
            var jsonPathCompiler = Object(__WEBPACK_IMPORTED_MODULE_5__jsonPathSyntax__[
              ...
              function duckTypeClause(previousExpr, detection) {
                ...
                var hasAllrequiredFields = Object(__WEBPACK_IMPORTED_MODULE_0__functional__[
                  ...
                  "c"
                  /* arrayAsList */
                ])(fieldListStr.split(/\W+/))), isMatch = Object(__WEBPACK_IMPORTED_MODULE_0__functional__[
                  "d"
                  /* compose2 */
              ...
              function generateClauseReaderIfTokenFound(tokenDetector, clauseEvaluatorGenerators, jsonPath, parserGeneratedSoFar, onSuccess) {
                ...
                if (detected) {
                  var compiledParser = expressionsReader(clauseEvaluatorGenerators, parserGeneratedSoFar, detected), remainingUnparsedJsonPath = jsonPath.substr(Object(__WEBPACK_IMPORTED_MODULE_3__util__[
                    "e"
                    /* len */
                  ])(detected[0]));
              ...
              var clauseForJsonPath = Object(__WEBPACK_IMPORTED_MODULE_0__functional__[
                ...
                clauseMatcher(pathNodeSyntax, Object(__WEBPACK_IMPORTED_MODULE_1__lists__[
                  "h"
                  /* list */
                ])(capture, duckTypeClause, nameClause, skip1)),
          ...
          function(module2, __webpack_exports__, __webpack_require__) {
            ...
            var jsonPathSyntax = function() {
              var regexDescriptor = function regexDescriptor2(regex) {
                ...
                return regexDescriptor(RegExp(componentRegexes.map(Object(__WEBPACK_IMPORTED_MODULE_0__functional__[
                  "c"
                  /* attr */
                ])("source")).join("")));
              ...
              return function(fn) {
                return fn(Object(__WEBPACK_IMPORTED_MODULE_0__functional__[
                  "h"
                  /* lazyUnion */
          ...
          function(module2, __webpack_exports__, __webpack_require__) {
            ...
            function streamingHttp(oboeBus, xhr, method, url, data, headers, withCredentials) {
                ...
                function sendStartIfNotAlready() {
                  try {
                    stillToSendStartEvent && oboeBus(__WEBPACK_IMPORTED_MODULE_1__events__[
                      "c"
                      /* HTTP_START */
                    ]).emit(xhr.status, Object(__WEBPACK_IMPORTED_MODULE_3__parseResponseHeaders_browser__[
                      "a"
              ...
              try {
                ...
                window.setTimeout(Object(__WEBPACK_IMPORTED_MODULE_4__functional__[
                  "j"
                  /* partialComplete */
                ])(emitFail, Object(__WEBPACK_IMPORTED_MODULE_1__events__[
                  "o"
